		  ...
		  <form class="form-horizontal" method="post" action="Controleur">
			  ...
			  <input type="hidden" name="action" value="ajoutStageModifie" />
				  <div class="form-group col-sm-12">
		    		...
		    		<div class="col-sm-7">
		    			<input type="text" name="id" class="form-control" value="${id}" id="numero" placeholder="Enter un numéro..." required>
		    		</div>
		  		  </div>
		  		  <div class="form-group col-sm-12">
		    		<label for="libelle" class="col-sm-2 control-label">Libellé</label>
		    		<div class="col-sm-7">
		    			<input type="text" name="libelle" class="form-control" value="${libelle}" id="libelle" placeholder="Enter un libellé..." required>
		    		</div>
		  		  </div>
		  		  <div class="form-group col-sm-12">
		    		<label for="datedebut" class="col-sm-2 control-label">Date de début de stage</label>
		    		<div class="col-sm-7">
		    			<input type="text" name="datedebut" class="form-control" value="${dateDebut}" id="datedebut" placeholder="Enter la date de début de stage..." required>
		    		</div>
		  		  </div>
		  		  <div class="form-group col-sm-12">
