		  ...
		  <form class="form-horizontal" method="post" action="Controleur">
			  ...
			  <input type="hidden" name="action" value="ajoutStage" />
				  <div class="form-group col-sm-12">
		  		  ...
		  		  <div class="form-group col-sm-12">
		    		<label for="datedebut" class="col-sm-3 control-label">Date de début de stage(format : yyyy-mm-dd)</label>
		    		<div class="col-sm-7">
		    			<input type="text" name="datedebut" class="form-control" id="datedebut" placeholder="Enter la date de début de stage..." required>
		    		</div>
		  		  </div>
		  		  <div class="form-group col-sm-12">
		    		<label for="datefin" class="col-sm-3 control-label">Date de fin de stage(format : yyyy-mm-dd)</label>
		    		<div class="col-sm-7">
		  		  ...
		  		  <div class="form-group col-sm-12">
		    		<label for="nbinscrits" class="col-sm-3 control-label">Nombre d'inscrits</label>
		    		<div class="col-sm-7">
